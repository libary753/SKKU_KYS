...
import csv
import FashionNet_Pre_Cat as fashionnet
import random
import os
...
class trainer:
    ...
    def load_batch_for_ret(self,batNum):
    ...
    def train(self):
        ...
        for i in range(20000):
            ...
            if self.model_type is 'full':
                sess.run(train,feed_dict={fn.img:self.batch,fn.landmark_visibility:self.v,fn.landmark_1:fn.landmark_roi[:,0],fn.landmark_2:fn.landmark_roi[:,1],fn.landmark_3:fn.landmark_roi[:,2],fn.landmark_4:fn.landmark_roi[:,3],fn.landmark_5:fn.landmark_roi[:,4],fn.landmark_6:fn.landmark_roi[:,5],fn.landmark_7:fn.landmark_roi[:,6],fn.landmark_8:fn.landmark_roi[:,7],self.output_category:self.cat_prob,fn.keep_prob:0.5}) 
            elif self.model_type is 'upper':
            ...
            #if i%50 is 0:
            if self.model_type is 'full':
                [l1,out]=sess.run([self.loss,fn.cat_prob],feed_dict={fn.img:self.batch,fn.landmark_visibility:self.v,fn.landmark_1:fn.landmark_roi[:,0],fn.landmark_2:fn.landmark_roi[:,1],fn.landmark_3:fn.landmark_roi[:,2],fn.landmark_4:fn.landmark_roi[:,3],fn.landmark_5:fn.landmark_roi[:,4],fn.landmark_6:fn.landmark_roi[:,5],fn.landmark_7:fn.landmark_roi[:,6],fn.landmark_8:fn.landmark_roi[:,7],self.output_category:self.cat_prob,fn.keep_prob:0.5})
            elif self.model_type is 'upper':
...
fn.restore_model(sess,'C:/Users/libar/Desktop/cat_'+tr.model_type+'_pre/final/model') 
...
for i in range(int(len(tr.img_list)/tr.batSize)):
    ...
    if tr.model_type is 'full':
        [out]=sess.run([fn.cat_prob],feed_dict={fn.img:tr.batch,fn.landmark_visibility:tr.v,fn.landmark_1:fn.landmark_roi[:,0],fn.landmark_2:fn.landmark_roi[:,1],fn.landmark_3:fn.landmark_roi[:,2],fn.landmark_4:fn.landmark_roi[:,3],fn.landmark_5:fn.landmark_roi[:,4],fn.landmark_6:fn.landmark_roi[:,5],fn.landmark_7:fn.landmark_roi[:,6],fn.landmark_8:fn.landmark_roi[:,7],tr.output_category:tr.cat_prob})
    elif tr.model_type is 'upper':
        [out]=sess.run([fn.cat_prob],feed_dict={fn.img:tr.batch,fn.landmark_visibility:tr.v,fn.landmark_1:fn.landmark_roi[:,0],fn.landmark_2:fn.landmark_roi[:,1],fn.landmark_3:fn.landmark_roi[:,2],fn.landmark_4:fn.landmark_roi[:,3],fn.landmark_5:fn.landmark_roi[:,4],fn.landmark_6:fn.landmark_roi[:,5],tr.output_category:tr.cat_prob})
    elif tr.model_type is 'lower':
        [out]=sess.run([fn.cat_prob],feed_dict={fn.img:tr.batch,fn.landmark_visibility:tr.v,fn.landmark_1:fn.landmark_roi[:,0],fn.landmark_2:fn.landmark_roi[:,1],fn.landmark_3:fn.landmark_roi[:,2],fn.landmark_4:fn.landmark_roi[:,3],tr.output_category:tr.cat_prob})
...
f=open('C:/Users/libar/Desktop/test_'+tr.model_type+'_pre.csv','w', encoding='utf-8', newline='')
